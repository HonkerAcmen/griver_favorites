...
def downgrade() -> None:
    op.execute("DROP INDEX IF EXISTS idx_griver_favorite_item_folder")

    op.execute("DROP INDEX IF EXISTS uq_griver_favorite_item_user_target_active")

    op.drop_table("griver_favorite_item")

    op.execute("DROP INDEX IF EXISTS idx_griver_favorite_folder_user_list")

    op.execute("DROP INDEX IF EXISTS uq_griver_favorite_folder_user_name_active")
